...
<aside class="column is-2 aside hero is-fullheight is-hidden-mobile">
    <div>
        <div class="main">
            ...
            <a href="{{ route('admin.users.index') }}" class="item @if($routeName == 'admin.users.edit' || $routeName == 'admin.users.index')active @endif"><span class="icon"><i class="fa fa-user"></i></span><span class="name">Users</span></a>
